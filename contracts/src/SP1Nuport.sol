...
import "@nuport/DataRootTuple.sol";
import "@nuport/lib/tree/binary/BinaryMerkleTree.sol";

import {ISP1Nuport} from "./interfaces/ISP1Nuport.sol";
import {IDAOracle} from "@nuport/IDAOracle.sol";
import {TimelockedUpgradeable} from "@succinctx/upgrades/TimelockedUpgradeable.sol";
import {ISP1Verifier} from "@sp1-contracts/ISP1Verifier.sol";

/// @notice SP1Nuport contract.
contract SP1Nuport is ISP1Nuport, IDAOracle, TimelockedUpgradeable {
    ...
    /// @notice The verification key for the SP1Nuport program.
    bytes32 public nuportProgramVkey;
    ...
    function initialize(InitParameters calldata _params) external initializer {
        ...
        nuportProgramVkey = _params.nuportProgramVkey;
    ...
    function updateProgramVkey(bytes32 _programVkey) external onlyGuardian {
        nuportProgramVkey = _programVkey;
    }
        ...
        onlyApprovedRelayer
    {
        ...
        verifier.verifyProof(nuportProgramVkey, publicValues, proof);
    ...
    /// the existing Nuport contract and is used to verify the data hash for a specific block
    ...
    function verifyAttestation(
        ...
        // Note: state_proofNonce slightly differs from Nuport.sol because it is incremented
        //   after each commit.
